...
<header>
	...
	<nav class="navbar navbar-light bg-light border-bottom py-3 mb-4">
		...
		<a class="end-0 col-1 me-5" href="/schoola/berandaOrtu" style="width: 50px; height:50px"><img src="\data_file\arrow.png" class="img-fluid"></a>
	  </nav>
