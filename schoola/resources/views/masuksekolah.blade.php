...
<body class="mulai">
    ...
    <div class="row" >
        ...
        @endif
            <form action="/schoola/loginsekolah" method="POST">
                @csrf
                <div class="mb-3 mt-3">
                    <label for="email" class="form-label" style="color:rgb(164, 19, 247)"><b>Email:</b></label>
                ...
                <div class="mb-3">
                    <label for="password" class="form-label" style="color:rgb(106, 44, 192)"><b>Password:</b></label>
                ...
                <p style="color:rgb(0, 0, 0);text-align:center"><b>Belum Punya Akun ? <a href="/schoola/daftarsekolah" class="linkdaftar">Daftar</a></p>
